...
class Command(BaseCommand):
    help = "Scrapes Dot & Key products and saves them to the database"
    ...
    def handle(self, *args, **options):
        ...
        while True:
            ...
            for p in products_list:
                is_hidden = (
                    any(tag.lower() in ["not-searchable", "app_freebie"] for tag in p["tags"])
        ...
        self.stdout.write(self.style.SUCCESS("Done scraping Dot & Key."))